package br.com.lincolntec.gestao_vagas.modules.candidate.useCases;
...
public class ApplyJobCandidateUseCaseTest {
    ...
    @Test
    public void sould_not_be_able_to_apply_job_with_job_not_found() {
        ...
        try {
            ...
            assertThat(e).isInstanceOf(JobNotFoundeException.class);
        }
    }

    @Test
    public void sould_be_able_to_crate_a_new_job() {
        var idCandidate = UUID.randomUUID();
